            ...
            <div className="surface rounded-3xl p-6 relative max-w-4xl w-full flex flex-col items-center max-h-[90vh] overflow-y-auto border border-[#f37021]/20">
              ...
              {!activeGame ? (
                ...
                <>
                  ...
                  {activeGame === 'rps' && (
                    <RockPaperScissors gameState={gameState} sendGameState={sendGameState} _currentUserRole={currentUserRole} />
                  )}
                  {activeGame === 'typing' && (
                    <TypingRace gameState={gameState} sendGameState={sendGameState} _currentUserRole={currentUserRole} />
                  )}
                  {activeGame === 'scratchpad' && (
                    <Scratchpad gameState={gameState} sendGameState={sendGameState} _currentUserRole={currentUserRole} />
                  )}
                </>
              )}
            </div>
