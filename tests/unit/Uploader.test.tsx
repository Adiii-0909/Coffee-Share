...
vi.mock('../../src/hooks/useUploaderConnections', () => ({ useUploaderConnections: () => ({ connections: [], chatMessages: [], sendChatMessage: vi.fn(), gameState: null, sendGameState: vi.fn() }) }))
...
describe('Uploader', () => {
  it('shows loading when channel loading', () => {
    ...
    expect(getByText('Creating share link...')).toBeInTheDocument()
  })
})
